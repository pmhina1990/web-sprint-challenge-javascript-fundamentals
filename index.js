...
// NESTED FUNCTION CAN ACCESS THE INTERNAL VARIABLE BECAUSE IT THE VARIBALE IN WITHIN ONE FUNCTION--MYFUNCTION()
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(){
    const usaPopulation = zooAnimals.reduce(function(accumulator,item){
